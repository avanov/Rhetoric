...
from rhetoric.registry import predvalseq
from rhetoric.compat import (
    bytes_,
    is_nonstr_iter,
    )
from rhetoric.exceptions import ConfigurationError
from rhetoric.util import TopologicalSorter
...
class not_(object):
    ...
    .. code-block:: python
       ...
       from rhetoric.config import not_
    ...
    - :meth:`rhetoric.config.Configurator.add_view`

    - :meth:`rhetoric.config.Configurator.add_route`

    - :meth:`pyramid.config.Configurator.add_subscriber`

    - :meth:`rhetoric.view.view_config`
